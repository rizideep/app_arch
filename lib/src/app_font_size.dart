// main screen padding
const double appPaddingHorizontal = 18.0;
const double appPaddingVertical = 10.0;
const double appScreenPaddingBottom = 30.0;

const double appScreenPaddingSecondLeftRight = 7.0;
const double appScreenPaddingSecondTop = 10.0;
const double appScreenPaddingSecondBottom = 10.0;

const double fontSize09 = 09.0;
